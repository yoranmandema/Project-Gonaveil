...
public class WeaponInventory : MonoBehaviour {
    ...
    public bool HasAnyWeapons {
        get {
            ...
            hasAnyWeapon = hasAnyWeapon || primary.weaponAsset != null;
            hasAnyWeapon = hasAnyWeapon || secondary.weaponAsset != null;
            hasAnyWeapon = hasAnyWeapon || grenade.weaponAsset != null;
    ...
    private bool isSlotAvailable(int slot) {
        switch (slot) {
            case 0:
                return primary.weaponAsset == null;
            case 1:
                return secondary.weaponAsset == null;
            case 2:
                return grenade.weaponAsset == null;
            default:
    ...
    private void CheckGrenades() {
        if (grenade.weaponMagazine == 0 && grenade.weaponAsset != null) {
            grenade.weaponAsset = null;
            CycleWeapon(1);
    ...
    //    dropData.weaponParameters = CurrentWeapon.weaponAsset;
    ...
    //    CurrentWeapon.weaponAsset = null;
    ...
    //        if (primary.weaponAsset == null) {
    //            primary.weaponAsset = dropData.weaponParameters;
    //            primary.SetInventoryAmmo(dropData.currentMagazineCapacity, dropData.currentAmmoPool);
    //        }
    //        else if (secondary.weaponAsset == null) {
    //            secondary.weaponAsset = dropData.weaponParameters;
    ...
    //    }
    //    else {
    //        if (grenade.weaponAsset == null) {
    //            grenade.weaponAsset = dropData.weaponParameters;
    ...
    //    }
    //    if (GrenadeFull) {
    //        if (grenade.weaponAsset.name == dropData.weaponParameters.name) {
    ...
    //    }
    //    if (WeaponFull) {
    //        if (primary.weaponAsset.name == dropData.weaponParameters.name) {
    ...
    //            SetWeapon();
    //        }
    //        else if (secondary.weaponAsset.name == dropData.weaponParameters.name) {
    ...
    void SetWeapon() {
        ...
        current = CurrentWeapon.weaponAsset;
